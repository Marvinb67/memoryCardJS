...
const rating = (moves) => {
    ...
    if (moves > stars3 && moves < stars2) {
        // TODO: supprimez la class fa-solid et ajoutez la class fa-regular du 3eme élément contenu dans ratingElement*
...
const addCardListener = () => {
    ...
    cards.forEach((card) => {
        card.addEventListener('click', (event) => {
            ...
            // TODO: vérifie que card possède la classe show OU la class match grâce à https://developer.mozilla.org/fr/docs/Web/API/Element/classList
            const cardIsShown = false // si card possède la classe show OU la class match, cardIsShown vaudra true
            // on ne veut pas que l'utilisateur clique sur une carte déjà retournée
            if (cardIsShown) {
                return true;
            }

            // TODO: ajoutez les classes open et show à l'élément card grâce à https://developer.mozilla.org/fr/docs/Web/API/Element/classList
            ...
            if (openedCards[0].icon === openedCards[1].icon) { // si les cartes ouvertes correspondent
                // TODO: ajoute la classe match aux cartes contenu dans openedCards
                // ...
                ...
                // Si les cartes ne correspondent pas, il y a un délai et les cartes se retournent face cachée.
            } else {
                setTimeout(function () {
                    // TODO: supprime les classes open et show des cartes contenu dans openedCards
                    // ...
